...
namespace VATS
{
	...
	void Settings::Load()
	{
		...
		aimPointHeightRadiusFactor = GetPrivateProfileFloatA("Targeting", "fAimPointHeightRadiusFactor", 1.03f, INI_PATH);
		...
		boxMaxSizeDistance = GetPrivateProfileFloatA("HUD", "fBoxMaxSizeDistanceMeters", 8.0f, INI_PATH);
		boxMinSizeDistance = GetPrivateProfileFloatA("HUD", "fBoxMinSizeDistanceMeters", 16.0f, INI_PATH);
		healthBarBelowBox = REX::W32::GetPrivateProfileIntA("HUD", "bHealthBarBelowBox", 0, INI_PATH) != 0;
		resourceBarBelowBox = REX::W32::GetPrivateProfileIntA("HUD", "bResourceBarBelowBox", 1, INI_PATH) != 0;
