...
namespace VATS
{
	...
	void Settings::Load()
	{
		...
		supportHealAmount = GetPrivateProfileFloatA("Support", "fHealAmount", 200.0f, INI_PATH);
		supportActionKeyVK = REX::W32::GetPrivateProfileIntA("Support", "iActionKey", 0x45, INI_PATH);
