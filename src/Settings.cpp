...
namespace VATS
{
	...
	void Settings::Load()
	{
		...
		springDeadzoneDeg = GetPrivateProfileFloatA("Combat", "fSpringDeadzoneDeg", 8.0f, INI_PATH);
		...
		springMaxDegPerSec = GetPrivateProfileFloatA("Combat", "fSpringMaxDegPerSec", 90.0f, INI_PATH);
